...
class Mail
{
	...
	public function __construct($fromName, $fromEmail, $toName, $toEmail, $subject, $content)
	{
		...
		$host = "smtp.gmail.com"; // If you have a Gmail account
        $port = "465"; // If you have a Gmail account
		$Username = ""; // Your Gmail account login 
		...
		$this->_mailer->AddAddress($toEmail, $toName);
		
		$this->_mailer->IsHTML(true);

		$this->_mailer->Subject = $subject . " - From PHPMailer";
	...
	public function addAttachment($file_path, $filename)
	{
		$this->_mailer->AddAttachment($file_path, $filename);
		
		$this->_mailer->Body    = $this->_mailer->Body . "<br><br>PS: Attachment from PHP Mailer";
	}
